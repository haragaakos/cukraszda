          ...
          <div class="row justify-content-center">
            <div class="col-sm-12 col-md-5 col-lg-4 col-xl-4 order-lg-2 offset-xl-1 mb-4">
              <div class="img-wrap text-center text-md-left" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="img">
                  <img src="assets/img/img_v_4.jpg" alt="circle image" class="img-fluid">
                </div>
              </div>
            </div>
            ...
            <div class="offset-md-0 offset-lg-1 col-sm-12 col-md-5 col-lg-5 col-xl-4" data-aos="fade-up">
              <div class="px-3">
                ...
                <p>
                  Legyen szó egy családi ünnepről, baráti találkozóról vagy éppen egy kis kényeztetésről, nálunk mindig megtalálhatják a tökéletes édességet. Várjuk Önöket szeretettel a Sweet Cake Cukrászdában, ahol az édes élet egy csipetnyi varázslattal válik még élvezetesebbé! 
                </p>
